...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    public class CustomerBbdoController(ICustomerBbdoService service) : ControllerBase
    {
        public readonly ICustomerBbdoService _service = service;
        [HttpGet("Search")]
        ...
        //[HttpGet("GetSpecialCustomerBbdo")]
        //public async Task<IActionResult> GetSpecialCustomerBbdo([FromQuery] BaseMdFilter filter)
        //{
        //    var transferObject = new TransferObject();
        //    var result = await _service.GetSpecialCustomerBbdo(filter);
        //    if (_service.Status)
        //    {
        //        transferObject.Data = result;
        //    }
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] CustomerBbdoDto CustomerBbdo)
        {
            var transferObject = new TransferObject();
            await _service.Update(CustomerBbdo);
            if (_service.Status)
            {
                transferObject.Status = true;
                transferObject.MessageObject.MessageType = MessageType.Success;
