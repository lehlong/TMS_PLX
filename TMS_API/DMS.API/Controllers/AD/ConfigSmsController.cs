...
namespace DMS.API.Controllers.AD
{
    ...
    [ApiController]
    public class ConfigSmsController(IConfigSmsService service) : ControllerBase
    {
        public readonly IConfigSmsService _service = service;
        [HttpGet("Search")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] JaGoodsDto JaGoods)
        {
            var transferObject = new TransferObject();
            var result = await _service.Add(JaGoods);
            if (_service.Status)
            {
                transferObject.Data = result;
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] SmsConfigDto JaGoods)
        {
            var transferObject = new TransferObject();
