...
namespace DMS.BUSINESS.Services.MD
{
    ...
    public class CustomerFobService(AppDbContext dbContext, IMapper mapper) : GenericService<TblMdCustomerFob, CustomerFobDto>(dbContext, mapper), ICustomerFobService
    {
        public override async Task<PagedResponseDto> Search(BaseFilter filter)
        {
            try
            {
                var query = _dbContext.TblMdCustomerFob.AsQueryable();
        ...
        public async Task<IList<CustomerFobDto>> GetAll(BaseMdFilter filter)
        {
            try
            {
                var query = _dbContext.TblMdCustomerFob.AsQueryable();
